    ...
    bg-white z-30 p-3'>
      ...
      item-center max-w-6xl mx-auto '>
        ...
        {/* menu items */}
        {
          session ? (
            ...
            <IoMdAddCircleOutline className='text-2xl cursor-pointer
            ...
            rounded-full cursor-pointer' onClick={signOut}/>
            </div>
          ):(
      ...
      </div>
      {
        isOpen && (
          ...
          top-56 left-[50%] translate-x-[-50%] bg-white border-2 rounded-md shadow-md'
          ...
          ariaHideApp={false}>
              <div className='flex flex-col justify-center items-center h-[100%]'>
                {
                  selectedFile ? (
                    <img src={imageFileUrl}
                          ...
                          alt='selected file'
                          className={`max-h-[250px] w-full object-cover ${imageFileUploading ? 'animate-pulse':''}`}/>
                  ):(
              ...
              <input type='text' maxLength='150' placeholder='please enter you caption...'
